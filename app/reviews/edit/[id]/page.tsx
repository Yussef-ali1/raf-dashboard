...
export default function EditReview({ params }: { params: { id: string } }) {
  ...
  const fetchReview = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://raf-backend.vercel.app/review/findOne/${params.id}`, {
        headers: {
  ...
  const onSubmit = async (data: FormData, lang: "ar" | "en") => {
    ...
    try {
      ...
      const response = await fetch(`https://raf-backend.vercel.app/review/update/${params.id}`, {
        method: "PUT",
