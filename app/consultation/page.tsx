...
const ConsultationPage = () => {
  ...
  const fetchConsultations = async () => {
    try {
      const response = await fetch('https://raf-backend.vercel.app/consultation/')
  ...
  const handleDelete = async (id: string) => {
    try {
      const response = await fetch(`https://raf-backend.vercel.app/consultation/${id}`, {
        method: 'DELETE',
      })
  ...
  const handleMarkAsCompleted = async (id: string) => {
    try {
        const response = await fetch(`https://raf-backend.vercel.app/consultation/markAsCompleted/${id}`, {
            method: 'PATCH',
            headers: {
...
const handleMarkAsCanceled = async (id: string) => {
    try {
        const response = await fetch(`https://raf-backend.vercel.app/consultation/markAsCanceled/${id}`, {
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
            },
